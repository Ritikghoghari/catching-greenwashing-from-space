# -*- coding: utf-8 -*-
"""
Script to create notebooks/prithvi_improved_colab.ipynb
Builds an end-to-end Google Colab notebook demonstrating:
1. Baseline Unsupervised Prithvi Cosine Distance
2. Technique 2: Biophysical Delta-NDVI Gated Filtering + Otsu Threshold
3. Technique 1: Supervised Linear Probing / Lightweight MLP Head on Frozen Embeddings
4. Side-by-side metrics comparison table (Precision, Recall, IoU, Spearman rho)
5. 5-panel publication-ready comparison figure
"""
...
out_path = r"C:\Users\Allah o akbar\thesis\notebooks\prithvi_improved_colab.ipynb"
